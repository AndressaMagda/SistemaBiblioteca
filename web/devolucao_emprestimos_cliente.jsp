    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h3 class="panel-title text-center">
                <strong>Visualizar Empréstimos de Cliente</strong>
            </h3>
        </div>
        <div class="panel-body">
            ...
            <div class="table-responsive">
                <form method="post" action="EmprestimoControler">
                    <input value="devolver_por_cliente" name="acao" type="hidden">
                    <input value="<%= id_cliente %>" name="id_cliente" type="hidden">
                    ...
                    <p style="margin-bottom: 20px; margin-top: 10px; font-size: 12pt; text-align: center;"><strong>Cliente: </strong><%= nome_cliente %></p>
