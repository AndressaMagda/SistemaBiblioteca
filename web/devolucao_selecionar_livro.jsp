    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h3 class="panel-title text-center">
                <strong>Devolução por Livro</strong>
            </h3>
        </div>
        <div class="panel-body">

            <form method="post" action="EmprestimoControler">
                <input value="devolucao_emprestimos_livro" name="acao" type="hidden">
                
                <div class="form-group">
                    <label for="select" class="col-lg-1 col-lg-offset-4 control-label" style="margin-top: 5px;">Livro</label>
                    <div class="col-lg-5">
